        ...
        <div class="w-full max-w-6xl mx-0 bg-white shadow-xl border border-gray-100">
            ...
            <div class="p-6 overflow-x-auto">
                    <form action="/employees" method="post" class="p-4 bg-white rounded-lg space-y-4">
                        ...
                        <select name="position.id" class="mt-1 block border border-gray-300 shadow-sm py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500" required>
                        ...
                        <div class="flex gap-3 pt-2">
                            ...
                            <a href="/" class="btn-dark-blue w-full py- px-4 font-medium text-center  hover:bg-sky-50 hover:text-sky-900 border-transparent hover:border-sky-900">Назад</a>
                        </div>
                    </form>
            </div>
        </div>
